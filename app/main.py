...
def add_prediction(input_data):
    ...
    st.write('Probability of Benign: %f' % model.predict_proba(input_array_scaled)[0][0])
    st.write('Probability of Malicious: %f' % model.predict_proba(input_array_scaled)[0][1])
...
def main():
    ...
    with st.container():
        ...
        st.write('Please connect this to your cytology lab help diagnose breast cancer form your tissue.\n')
